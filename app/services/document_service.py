...
class DocumentService:
    ...
    def process_documents_task(self, job_id: str, 
        ...
        try:
            ...
            temp_max_chunk_size = chunk_size if chunk_size is not None else self.doc_processor.max_chunk_size
            temp_min_chunk_size = min_size if min_size is not None else self.doc_processor.min_chunk_size
            temp_chunk_overlap = overlap if overlap is not None else self.doc_processor.chunk_overlap
            temp_enable_chunking = enable_chunking if enable_chunking is not None else self.doc_processor.enable_chunking
    ...
    def _process_directory(self, directory: str, job_id: str,
                          ...
                          enhance_chunks: bool) -> Tuple[List[str], List[str], List[str], int, int, List[str]]:
        """
    ...
    def _process_chunks(self, chunk_list: List[Tuple[str, str]], 
                      ...
                      failed_files: List[str]) -> Tuple[int, int]:
        """
    ...
    def process_single_file_task(self, job_id: str, file_path: str) -> None:
        """
        ...
        try:
            ...
            try:
                ...
                with open(file_path, "r", encoding="utf-8") as f:
                    ...
                    # Apply chunking
                    chunks = self.doc_processor.chunk_document(content, rel_path)

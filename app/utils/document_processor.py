...
class DocumentProcessor:
    """
    Handles document processing operations including text chunking
    """
    
    def __init__(self, max_chunk_size: int = 1000, min_chunk_size: int = 200, chunk_overlap: int = 100, enable_chunking: bool = True):
        """
    ...
    def chunk_document(self, document: str, file_path: str) -> List[Tuple[str, str]]:
        """
        ...
        if not self.enable_chunking or len(document) < self.max_chunk_size:
